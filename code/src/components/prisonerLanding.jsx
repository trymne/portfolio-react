...
const PrisonerLanding = () => {
    ...
    //     console.log("Are you trying to cheat? Here is the correct order of slips: ")
    ...
    return (
        <div {...stylex.props(styles.main)}>
            <h1 {...stylex.props(styles.h1)}>The 100 Prisoners Problem</h1>
...
export default PrisonerLanding;
